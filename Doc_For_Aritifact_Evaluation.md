...
```
- Additionally, a small amount of manual effort is required to validate whether the reported bugs are true. Nevertheless, the results confirm our main claim that the generated specifications can detect numerous new bugs.
